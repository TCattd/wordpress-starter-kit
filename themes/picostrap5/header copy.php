  ...
  <!-- ******************* The Navbar Area ******************* -->
    ...
    <nav class="navbar navbar-expand-lg <?php echo get_theme_mod('picostrap_header_navbar_position')." ". get_theme_mod('picostrap_header_navbar_color_scheme','navbar-dark').' '. get_theme_mod('picostrap_header_navbar_color_choice','bg-dark'); ?>">
      ...
      <div class="container" >
          ...
          <div id="logo-tagline-wrap">
            ...
            <?php if ( ! has_custom_logo() ) { ?>
              ...
              <?php if ( is_front_page() && is_home() ) : ?>
                ...
                <div class="navbar-brand mb-0 h3 d-inline"><a rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" itemprop="url"><?php bloginfo( 'name' ); ?></a></div>
        ...
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle navigation', 'picostrap' ); ?>">
